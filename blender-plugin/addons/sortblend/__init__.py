...
def unregister():
    ...
    # remove the load post handler
    if material.node_groups_load_post in bpy.app.handlers.load_post:
        bpy.app.handlers.load_post.remove(material.node_groups_load_post)
